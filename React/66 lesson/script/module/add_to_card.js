...
var myFunction = function(ttl, prc, img) {
  let title = ttl;
  let price = prc;
  let image = img;
...
document.querySelector(".list_item").addEventListener("click", event => {
  ...
  if (event.target.parentNode.classList.contains("product")) return false;
    ...
    var ttl = event.target.parentNode.parentNode.parentNode.parentNode.parentNode.querySelectorAll(".ttl");
    var price = event.target.parentNode.parentNode.parentNode.parentNode.querySelectorAll(".price span");
    var img = event.target.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.querySelectorAll(".img img");
  //console.log("Janara");
